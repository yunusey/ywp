...
static void handle_pointer_enter(void *data, struct wl_pointer *poiner, uint32_t serial, struct wl_surface *surface,
...
static void handle_pointer_motion(void *data, struct wl_pointer *wl_pointer, uint32_t time, wl_fixed_t surface_x,
                                  wl_fixed_t surface_y)
{
    int x = wl_fixed_to_int(surface_x);
    int y = wl_fixed_to_int(surface_y);
}
static void handle_pointer_button(void *data, struct wl_pointer *wl_pointer, uint32_t serial, uint32_t time,
                                  uint32_t button, uint32_t state)
{
    platform.cursor.input_serial = serial;
}
static void handle_pointer_axis(void *data, struct wl_pointer *wl_pointer, uint32_t time, uint32_t axis,
                                wl_fixed_t value)
{
...
static void handle_keyboard_keymap(void *data, struct wl_keyboard *kb, uint32_t format, int32_t fd, uint32_t size)
{
    ...
    platform.xkb.keymap = xkb_keymap_new_from_string(platform.xkb.context, map_str, XKB_KEYMAP_FORMAT_TEXT_V1,
...
static void handle_keyboard_enter(void *data, struct wl_keyboard *kb, uint32_t s, struct wl_surface *surf,
...
static void handle_keyboard_key(void *data, struct wl_keyboard *kb, uint32_t s, uint32_t time, uint32_t key,
                                uint32_t state)
{
}
static void handle_keyboard_modifiers(void *data, struct wl_keyboard *kb, uint32_t s, uint32_t mods_depressed,
...
bool init_platform(void)
{
    ...
    platform.layer_surface = zwlr_layer_shell_v1_get_layer_surface(platform.layer_shell, platform.surface, NULL,
                                                                   ZWLR_LAYER_SHELL_V1_LAYER_BACKGROUND, "wayland_app");
